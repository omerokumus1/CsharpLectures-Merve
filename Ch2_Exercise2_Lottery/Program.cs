...
namespace Ch2_Exercise2_Lottery
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            // 1. Generate a two-digit random number (lottery number)
            Random random = new Random(1); // burada Seed testlerin hızlı yapılması amaçlı kullanılıyor
            ...
            else
            {
                ...
                int guessDigit2 = guess / 10; // tek basamaklı inputlarda burası otomatik olarak sıfır olur. Örn; 8 / 10 = 0
                ...
                // Note: if if bağlantıları hatalı. İki if de çalışacağı durumlar var
